...
then
    ...
    vercomp 10.12 $(defaults read loginwindow SystemVersionStampAsString)
    if [ $? == "2" ]
    then
...
# now zsh. To silence this warning, you can add this command to ~/.bash_profile
# or ~/.profile:
